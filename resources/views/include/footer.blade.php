                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-2 col-lg-2 col-xl-2 ftr-colm1">
                        <h3>
                            Know more</h3>
                        <ul class="icon-before">
                            <li><a href="{{ route('govbody') }}"><i class="fas fa-child"></i> The Governing Body</a></li>
                            <li><a href="{{ route('course_list') }}"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Programs </a></li>
                            <li><a href="{{ route('image-gallery') }}"> <i class="fas fa-university    "></i> University Gallery</a></li>
                            <li><a href="{{route('media-gallery')}}"> <i class="fas fa-newspaper    "></i> Media Gallery</a></li>

                            <li> <a href="{{ route('appointment') }}"><i class="fas fa-envelope-open-text"></i>  Appointment Letter</a></li>
                            <li><a href="{{ route('requiters') }}"><i class="fas fa-user-tie"></i>   Our Requiters </a></li>
                            <li><a href="{{ route('placement-contact') }}"><i class="fas fa-id-card-alt"></i>    Placement Contact </a></li>
