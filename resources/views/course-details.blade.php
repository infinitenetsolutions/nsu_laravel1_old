                                ...
                                <div class="responsive-tabs-container accordion-xs accordion-sm">
                                    <ul class="nav nav-tabs responsive-tabs">
                                        ...
                                        @if (strlen($data->fee) > 20)
                                            <li class="active"> <a href="#tab1" data-toggle="tab"> <span> Course Fee
                                                    </span> </a>
                                            </li>
                                        @endif

                                        @if (url_check($url . 'CourseDetails/' . $data->syllabus))
                                            <li> <a href="#tab3" data-toggle="tab"> <span> Syllabus(Hons)</span></a></li>
                                        @endif
                                        @if (url_check($url . 'CourseDetails/' . $data->syllabus1) == true)
                                            <li><a href="#tab7" data-toggle="tab"> <span>Syllabus(Genral) </span></a></li>
                                        @endif
                                    ...
                                    <div class="tab-content">
                                        <h4 id="ctl00_ContentPlaceHolder1_headyear1" class="collapsible_heading open">1st
                                        ...
                                        <div class="tab-pane fade" id="tab3">
                                            <h4 class="line-bottom-theme-colored-2 mb-20">Sullabus(Hons) - <a
                                                    class="text-danger"
                                                    href="{{ $url . 'CourseDetails/' . $data->syllabus }}"> Download</a>
                                            </h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-2">
                                            ...
                                            <p>Aggregate percentage will be calculated on the basis of marks scored in
                                                ...
                                                Education, Fine Arts, Performing Arts or any other Vocational /Non-Written
                                                subjects).<strong> Student should have passed all the subjects of class XII
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-2">
                                            <p>For the time being Selection Process is based on video responses to the
                                                questions posted through the VIDEO LINK available on Admission Microsite.
                                            </p>
