                                            ...
                                            <div class="border-1px p-25">
                                                ...
                                                <form id="appointment_form" name="appointment_form" class="mt-30" method="post"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group mb-10">
                                                                <label for="">Drop Your Resume : ( <span class="text-danger">max size 1 mb </span>)  </label>
                                                                <input accept="application/pdf" name="resume" class="form-control required " type="file"
